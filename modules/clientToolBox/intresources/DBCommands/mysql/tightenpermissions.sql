...
grant SELECT,INSERT,UPDATE,DELETE,INDEX on ${url.path}.TableProtectData to '${database.username}'@'%';
...
grant SELECT,INSERT on ${url.path}.ProtectedLogData to '${database.username}'@'%';
grant SELECT,INSERT on ${url.path}.ProtectedLogTokenData to '${database.username}'@'%';

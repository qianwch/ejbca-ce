 ...
 * @version $Id$
 */
public class TestCustomCertSerialnumberWS extends CommonEjbcaWSTest {

	private static final Logger log = Logger.getLogger(TestCustomCertSerialnumberWS.class);

...
public class AuthenticationModulesTest extends CmpTestCase {
	...
	public void test02HMACConfigModule() throws Exception {
	...
	public void test03EEModule() throws InvalidKeyException, NoSuchAlgorithmException, NoSuchProviderException, SignatureException, IOException, InvalidAlgorithmParameterException,
		...
		eemodule.setSession(admin, caAdminSession, userAdminSession, certSession, authorizationSession, eeProfileSession);
	...
	public void test04EEConfigModule() throws NoSuchAlgorithmException, EjbcaException, IOException, Exception  {
		assertFalse("Configurations have not been backed up before starting testing.", confSession.backupConfiguration());

...
public class EndEntityProfileTest extends TestCase {
    ...
    public void test11EndEntityProfileReferenceDetection() throws Exception {
        ...
        try {
        	...
        	assertTrue("Unable to detect that Certificate Profile Id was present in End Entity Profile.", !endEntityProfileSession.getEndEntityProfilesUsingCertificateProfile(admin, 1337).isEmpty());
        	assertFalse("Unable to detect that Certificate Profile Id was not present in End Entity Profile.", !endEntityProfileSession.getEndEntityProfilesUsingCertificateProfile(admin, 7331).isEmpty());

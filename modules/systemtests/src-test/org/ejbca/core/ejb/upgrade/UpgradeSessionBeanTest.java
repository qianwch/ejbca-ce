...
public class UpgradeSessionBeanTest {
     ...
     */
    @Test
    public void testPostUpgradeTo6211EKUAndCustomCertExtensionsAccessRules() throws RoleExistsException, AuthorizationDeniedException, RoleNotFoundException {
        ...
        try {
            upgradeSession.upgrade(null, "6.2.10", true);

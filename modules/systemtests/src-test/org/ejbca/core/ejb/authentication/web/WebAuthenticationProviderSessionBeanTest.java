...
public class WebAuthenticationProviderSessionBeanTest {
     ...
     */
    @Test
    public void testAuthenticateWithNotifiedAboutExpiration() throws InvalidKeyException, CertificateEncodingException, NoSuchAlgorithmException, SignatureException, IllegalStateException, NoSuchProviderException, CreateException, AuthorizationDeniedException {

...
public abstract class RoleUsingTestCase {
    ...
    public void setUpAuthTokenAndRole(String roleName) throws RoleExistsException, RoleNotFoundException {
        ...
        final RoleAccessSessionRemote roleAccessSessionRemote = JndiHelper.getRemoteSession(RoleAccessSessionRemote.class);
        if (roleAccessSessionRemote.findRole(roleName) == null) {
            final RoleInitializationSessionRemote roleInitSession = JndiHelper.getRemoteSession(RoleInitializationSessionRemote.class);
    ...
    public void tearDownRemoveRole() throws RoleNotFoundException, AuthorizationDeniedException {
        final RoleManagementSessionRemote roleManagementSession = JndiHelper.getRemoteSession(RoleManagementSessionRemote.class);
        final RoleAccessSessionRemote roleAccessSessionRemote = JndiHelper.getRemoteSession(RoleAccessSessionRemote.class);
        if (roleAccessSessionRemote.findRole(roleName) != null) {
    ...
    protected AuthenticationToken createAuthenticationToken(String issuerDn) {
        ...
        principals.add(p);
        final SimpleAuthenticationProviderRemote authenticationProvider = JndiHelper.getRemoteSession(SimpleAuthenticationProviderRemote.class);

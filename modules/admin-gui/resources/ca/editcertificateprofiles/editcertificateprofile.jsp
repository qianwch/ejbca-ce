...
<h:form id="cpf">
	...
	<h:panelGrid columns="2" styleClass="edit-top" cellspacing="3" cellpadding="3" border="0" width="100%" rowClasses="Row0,Row1" columnClasses="editColumn1,editColumn2">
		...
		<h:panelGroup id="checkusemstemplategroup">
			...
			<h:commandButton id="checkusemstemplate" styleClass="checkBoxOverlay" action="#{certProfileBean.toggleUseMicrosoftTemplate}"
				value="#{certProfileBean.certificateProfile.useMicrosoftTemplate?web.text.BOOL_TRUE:web.text.BOOL_FALSE}" disabled="#{certProfilesBean.authorizedToOnlyView}"/>
		...
		<h:panelGrid columns="1">
			...
			<h:dataTable id="textfielddocumenttype" value="#{certProfileBean.documentTypeList}" var="current" rendered="#{certProfileBean.certificateProfile.useDocumentTypeList}">
				<h:column>
					...
					<f:facet name="footer">
						<h:inputText value="#{certProfileBean.documentTypeListNew}" size="45" maxlength="4096" disabled="#{certProfilesBean.authorizedToOnlyView}"/>
					</f:facet>
				</h:column>
				<h:column>
	...
	<h:panelGrid columns="2" styleClass="edit" cellspacing="3" cellpadding="3" border="0" width="100%" rowClasses="Row0,Row1" columnClasses="editColumn1,editColumn2">
		...
		<h:selectManyListbox rendered="#{certProfileBean.typeEndEntity}" id="selectavailablepublishers" value="#{certProfileBean.certificateProfile.publisherList}"
			size="#{certProfileBean.publisherListAvailableSize}" converter="javax.faces.Integer" style="min-width: 280px;" disabled="#{certProfilesBean.authorizedToOnlyView}">
		...
		<h:panelGrid columns="1" id="approvalSettings">
			<h:panelGrid columns="4">
				<h:selectBooleanCheckbox id="approvalEnabledAddEndEntity" value="#{certProfileBean.approvalEnabledAddEndEntity}" disabled="#{certProfilesBean.authorizedToOnlyView}"/>
				<h:outputLabel for="approvalEnabledAddEndEntity" value="#{web.text.APPROVEADDEDITENDENTITY}"/>
				<h:selectBooleanCheckbox id="approvalEnabledKeyRecover" value="#{certProfileBean.approvalEnabledKeyRecover}" disabled="#{certProfilesBean.authorizedToOnlyView}"/>
				<h:outputLabel for="approvalEnabledKeyRecover" value="#{web.text.APPROVEKEYRECOVER}"/>
				<h:selectBooleanCheckbox id="approvalEnabledRevocation" value="#{certProfileBean.approvalEnabledRevocation}" disabled="#{certProfilesBean.authorizedToOnlyView}"/>
				<h:outputLabel for="approvalEnabledRevocation" value="#{web.text.APPROVEREVOCATION}"/>
				<h:selectBooleanCheckbox id="approvalEnabledActivateCa" value="#{certProfileBean.approvalEnabledActivateCa}" disabled="#{certProfilesBean.authorizedToOnlyView}"/>

 ...
 * @version $Id$
 */
public class TestFixEndOfBrokenXML extends TestCase {

	private static Logger log = Logger.getLogger(TestFixEndOfBrokenXML.class);

	private byte[] readXmlFromFile() throws IOException {
		final InputStream is = TestFixEndOfBrokenXML.class.getResourceAsStream("test.xml");

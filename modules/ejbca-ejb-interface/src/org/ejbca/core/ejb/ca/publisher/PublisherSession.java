...
public interface PublisherSession {
     ...
     *         
     */
    BasePublisher getPublisher(AuthenticationToken authenticationToken, int id);
     ...
     */
    BasePublisher getPublisher(AuthenticationToken authenticationToken, String name);

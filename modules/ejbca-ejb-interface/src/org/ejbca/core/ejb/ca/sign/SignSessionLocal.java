...
public interface SignSessionLocal extends SignSession {
     ...
     */
    Certificate createCertificate(AuthenticationToken admin, String username, String password, PublicKey pk) throws EjbcaException,
     ...
     */
     Certificate createCertificate(AuthenticationToken admin, String username, String password, PublicKey pk, int keyusage, Date notBefore,
            ...
            InvalidAlgorithmException, CustomCertificateSerialNumberException, EjbcaException, CesecoreException;

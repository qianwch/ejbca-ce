...
/*
    public void test10TestOpenScep() throws Exception {
        ...
        log.debug("Reset status of 'foo' to NEW");
        IResponseMessage resp = TestTools.getSignSession().createCertificate(admin, new ScepRequestMessage(openscep), -1, Class.forName("org.ejbca.core.protocol.ScepResponseMessage"));

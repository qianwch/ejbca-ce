    ...
    public static void main(String[] args) {
        try {
            ...
            if (cmd != null) {
                ...
                System.out.println(
                    "Usage: edituser | finduser | findcerts | pkcs10req | pkcs12req | revokecert | getpublisherqueuelength | revoketoken | revokeuser | checkrevokationstatus | generatenewuser | createcrl | cacertrequest | cacertresponse | stress");
            }
        } catch (Exception e) {

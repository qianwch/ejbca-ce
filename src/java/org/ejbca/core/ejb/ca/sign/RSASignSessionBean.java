...
public class RSASignSessionBean implements SignSessionLocal, SignSessionRemote {
    ...
    public Certificate createCertificate(final AuthenticationToken admin, final String username, final String password, final Certificate incert) throws CesecoreException,
        ...
        return createCertificate(admin, username, password, cert.getPublicKey(), CertTools.sunKeyUsageToBC(cert.getKeyUsage()), null, null);
    }

    @Override
    public ResponseMessage createCertificate(final AuthenticationToken admin, final RequestMessage req, final Class<? extends ResponseMessage> responseClass, final EndEntityInformation suppliedUserData)

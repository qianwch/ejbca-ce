...
public class LocalLogSessionBean extends BaseSessionBean {
     ...
     */
    public void doSyncronizedLog(ILogDevice dev, Admin admin, int caid, int module, Date time, String username, X509Certificate certificate, int event, String comment, Exception ex) {

...
public abstract class CA extends UpgradeableDataHashMap implements Serializable {
     ...
     *         request.
     */
    public abstract byte[] signRequest(byte[] request, boolean usepreviouskey, boolean createlinkcert, CertificateProfile certProfile) throws CryptoTokenOfflineException;

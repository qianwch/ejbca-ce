 ...
 *
 * @version $Id: LocalCertificateStoreSessionBean.java,v 1.42.2.2 2003-09-09 20:10:00 anatom Exp $
 */
public class LocalCertificateStoreSessionBean extends BaseSessionBean {
     ...
     */
     public Collection findCertificatesByType(Admin admin, int type, String issuerDN) {
        ...
        if (null == admin 
            || type <= 0 
            || type > SecConst.CERTTYPE_CA + SecConst.CERTTYPE_ENDENTITY + SecConst.CERTTYPE_ROOTCA) {
            throw new IllegalArgumentException();        
        }
        StringBuffer ctypes = new StringBuffer();
        if ((type & SecConst.CERTTYPE_CA) > 0) {
            ctypes.append(SecConst.CERTTYPE_CA);
        }

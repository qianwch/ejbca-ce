...
public class TestCertificateRetrival extends TestCase  {
    ...
    static byte[] testrootcert = Base64.decode(("MIICnTCCAgagAwIBAgIBADANBgkqhkiG9w0BAQQFADBEMQswCQYDVQQGEwJTRTET"
                                                ...
                                                + "iQ==").getBytes());
    static byte[] testcacert = Base64.decode(("MIIB/zCCAWgCAQEwDQYJKoZIhvcNAQEEBQAwRDELMAkGA1UEBhMCU0UxEzARBgNV"
                                                ...
                                                + "6VVteg/JuBQa42zX11b5zFrOJlaQjJMSXc19MNXbjCuN8LY=").getBytes());
    static byte[] testcert = Base64.decode(("MIICBDCCAW0CAQEwDQYJKoZIhvcNAQEEBQAwTDELMAkGA1UEBhMCU0UxEzARBgNV"
                                            ...
                                            + "qy0rclhwsS7teP7+SKm4N+RSC4eYh5bib1G8Io1xo1PfjXxJMfKwwA==").getBytes());
    ...
    public void test06RetriveAllCertificates() throws Exception {
        ...
        Iterator iter;
        Collection certfps = store.findCertificatesByType(new Admin(Admin.TYPE_INTERNALUSER)
                                                          , SecConst.CERTTYPE_ROOTCA + SecConst.CERTTYPE_CA + SecConst.CERTTYPE_ENDENTITY
                                                          , null);
        assertNotNull("failed to list certs", certfps);
        assertTrue("failed to list certs", certfps.size() >= 2);

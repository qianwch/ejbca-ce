...
ALTER TABLE AccessRulesData ADD rowProtection CLOB DEFAULT NULL; 
ALTER TABLE AdminEntityData ADD rowProtection CLOB DEFAULT NULL;
ALTER TABLE AdminGroupData ADD rowProtection CLOB DEFAULT NULL;
ALTER TABLE AdminPreferencesData ADD rowProtection CLOB DEFAULT NULL;
ALTER TABLE ApprovalData ADD rowProtection CLOB DEFAULT NULL;
ALTER TABLE AuthorizationTreeUpdateData ADD rowProtection CLOB DEFAULT NULL;
ALTER TABLE CAData ADD rowProtection CLOB DEFAULT NULL;
ALTER TABLE CRLData ADD rowProtection CLOB DEFAULT NULL;
ALTER TABLE CertReqHistoryData ADD rowProtection CLOB DEFAULT NULL;
ALTER TABLE CertificateData ADD rowProtection CLOB DEFAULT NULL;
ALTER TABLE CertificateProfileData ADD rowProtection CLOB DEFAULT NULL;
ALTER TABLE EndEntityProfileData ADD rowProtection CLOB DEFAULT NULL;
ALTER TABLE GlobalConfigurationData ADD rowProtection CLOB DEFAULT NULL;
ALTER TABLE HardTokenCertificateMap ADD rowProtection CLOB DEFAULT NULL;
ALTER TABLE HardTokenData ADD rowProtection CLOB DEFAULT NULL;
ALTER TABLE HardTokenIssuerData ADD rowProtection CLOB DEFAULT NULL;
ALTER TABLE HardTokenProfileData ADD rowProtection CLOB DEFAULT NULL;
ALTER TABLE HardTokenPropertyData ADD rowProtection CLOB DEFAULT NULL;
ALTER TABLE KeyRecoveryData ADD rowProtection CLOB DEFAULT NULL;
ALTER TABLE LogConfigurationData ADD rowProtection CLOB DEFAULT NULL;
ALTER TABLE LogEntryData ADD rowProtection CLOB DEFAULT NULL;
ALTER TABLE PublisherData ADD rowProtection CLOB DEFAULT NULL;
ALTER TABLE ServiceData ADD rowProtection CLOB DEFAULT NULL;
ALTER TABLE UserData ADD rowProtection CLOB DEFAULT NULL;
ALTER TABLE UserDataSourceData ADD rowProtection CLOB DEFAULT NULL;
